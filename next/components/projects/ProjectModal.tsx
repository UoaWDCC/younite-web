...
const ProjectModal = ({
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 ">
      <div
        className="rounded-lg overflow-hidden w-[27rem] relative shadow-lg"
        style={{
      ...
      >
        ...
        >
          <h1 className="text-white text-[27px] text-xl font-[1000] mb-5 mt-2 text-center relative z-20">
            {" "}
            {title}{" "}
          </h1>
          <p className="text-white text-[16px] text-center mb-6 relative z-20">
            {" "}
            {description}{" "}
          </p>
